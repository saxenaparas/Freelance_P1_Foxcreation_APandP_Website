        ...
        >
          ...
          <div className="hero-container position-relative">
            <div className="d-flex flex-column gspace-2">
              ...
              >
                AP&A SYSTEM, <br /><span>Transforming Businesses with Smart People & Smarter Tech</span>
              </h1>
              ...
              <div className="d-flex flex-column gspace-5">
                <div className="d-flex flex-column gspace-2">
                  ...
                  <p
                    ...
                    data-animate="animate__fadeInDown"
                  >
                    In today’s fast-paced digital era, success demands more than visibility — it requires impact. At AP&A SYSTEM, we don’t just build strategies, we build growth engines that turn your vision into measurable business outcomes.
                  </p>
                </div>
                  ...
                  <div className="card-chooseus-cta-layout">
                    ...
                    <div className="d-flex flex-column align-items-end">
                      ...
                      <div className="card-chooseus-cta-wrapper">
                        ...
                        >
                          <h5>
                            Partner with AP&A SYSTEM, take your brand to the next
                            level.
                          </h5>
                ...
                >
                  <div className="card-testimonial-header-title">
                    ...
                    <p>
                      ...
                      with AP&A SYSTEM's expert digital marketing solutions.
                    </p>
                  </div>
                </div>
              </div>
                          ...
                          <div className="d-flex flex-row gspace-2">
                            ...
                            <div className="d-flex flex-column">
                              ...
                              <p className="testimonial-description">
                                We’ve implemented this HMS across multiple departments, and it has been a game-changer. The system is secure, user-friendly, and customizable to our needs. It has significantly reduced manual errors and paperwork.
                              </p>
                              <div className="d-flex flex-row align-items-center justify-content-between">
                                <div className="d-flex flex-row gspace-2">

                                  <div className="d-flex flex-column">
                                    <span className="profile-name">Dr. Anil Mehta</span>
                                    <p className="profile-info">Hospital Administrator</p>
                                  </div>
                                </div>
                        ...
                        <div className="d-flex flex-row align-items-center justify-content-between">
                          <div className="d-flex flex-row gspace-2">
                            ...
                            <div className="d-flex flex-column">
                              ...
                              <p className="testimonial-description">
                                The School Management System from AP&A SYSTEM has completely modernized how our school operates. Attendance, fee management, and report generation are now quick and accurate. It has saved our teachers a lot of time.
                              </p>
                              <div className="d-flex flex-row align-items-center justify-content-between">
                                <div className="d-flex flex-row gspace-2">

                                  <div className="d-flex flex-column">
                                    <span className="profile-name">Mrs. Sunita Sharma</span>
                                    <p className="profile-info">Principal</p>
                                  </div>
                                </div>
                                <i className="fa-solid fa-3x fa-quote-right accent-color"></i>
                              </div>
                        ...
                        <div className="d-flex flex-row align-items-center justify-content-between">
                          <div className="d-flex flex-row gspace-2">
                            ...
                            <div className="d-flex flex-column">
                              ...
                              <p className="testimonial-description">
                                The Hotel Management System has simplified our daily operations. From reservations to billing and housekeeping, everything is now fully automated and easy to monitor. It has greatly improved guest satisfaction and staff efficiency.
                              </p>
                              <div className="d-flex flex-row align-items-center justify-content-between">
                                <div className="d-flex flex-row gspace-2">

                                  <div className="d-flex flex-column">
                                    <span className="profile-name">Mr. Rohit Malhotra</span>
                                    <p className="profile-info">General Manager</p>
                                  </div>
                                </div>
                                <i className="fa-solid fa-3x fa-quote-right accent-color"></i>
                              </div>
                        ...
                        <div className="d-flex flex-row align-items-center justify-content-between">
                          <div className="d-flex flex-row gspace-2">
                            ...
                            <div className="d-flex flex-column">
                              ...
                              <p className="testimonial-description">
                                We were looking for a scalable HR solution, and this system exceeded our expectations. It provides complete transparency and helps our team stay organized and motivated. The support from AP&A SYSTEM has been excellent.
                              </p>
                              <div className="d-flex flex-row align-items-center justify-content-between">
                                <div className="d-flex flex-row gspace-2">

                                  <div className="d-flex flex-column">
                                    <span className="profile-name">Mr. Arvind Sharma</span>
                                    <p className="profile-info">CEO</p>
                                  </div>
                                </div>
                                <i className="fa-solid fa-3x fa-quote-right accent-color"></i>
                              </div>
                        ...
                        <div className="d-flex flex-row align-items-center justify-content-between">
                          <div className="d-flex flex-row gspace-2">
                            ...
                            <div className="d-flex flex-column">
                              ...
                              <p className="testimonial-description">
                                Partnering with AP&A SYSTEM for our IT solutions was one of the best decisions we made. Their team understood our needs perfectly and delivered a robust system that improved our efficiency and security.
                              </p>
                              <div className="d-flex flex-row align-items-center justify-content-between">
                                <div className="d-flex flex-row gspace-2">

                                  <div className="d-flex flex-column">
                                    <span className="profile-name">Mr. Rakesh Sinha</span>
                                    <p className="profile-info">Founder & CEO</p>
                                  </div>
                                </div>
                                <i className="fa-solid fa-3x fa-quote-right accent-color"></i>
                              </div>
              ...
              <div className="row row-cols-xl-2 row-cols-1 grid-spacer-5">
                ...
                <div className="col">
                  ...
                  >
                    ...
                    <p>Start your journey with AP&A SYSTEM</p>
                    <div className="link-wrapper">
