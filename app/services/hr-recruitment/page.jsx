      ...
      <div className="container py-5">
        ...
        <div className="mb-5 text-center">
          ...
          <p className="lead mx-auto" style={{ maxWidth: '700px' }}>
            At <strong>AP&A SYSTEM</strong>, we bridge the gap between skilled professionals and growing businesses. 
        ...
        <div className="text-center mt-5">
          ...
          <p className="mx-auto" style={{ maxWidth: '600px' }}>
            Partner with <strong>AP&A SYSTEM</strong> to simplify recruitment and hire smarter. 
